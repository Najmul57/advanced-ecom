        ...
        <div class="container fill_height">
            <div class="row fill_height">
                <div class="banner_product_image"><img src="{{ asset('files/products/' . $bannerproduct->thumbnail) }}"
                        alt="{{ 'files/products/' . $bannerproduct->name }}"></div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ asset('files/products/' . $item->thumbnail) }}"
                                                        alt="{{ $item->name }}" height="90%" width="70%" />
                                                </div>
                                                <div class="product_content">
                                                    ...
                                                    <div class="product_name">
                                                        <div><a href="{{ route('product.details', $item->slug) }}"
                                                                title="{{ $item->name }}">{{ substr($item->name, 0, 10) }}...</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ asset('files/products/' . $row->thumbnail) }}"
                                                        alt="{{ $row->name }}" height="90%" width="70%" />
                                                </div>
                                                <div class="product_content">
                                                    ...
                                                    <div class="product_name">
                                                        <div><a href="{{ route('product.details', $row->slug) }}"
                                                                title="{{ $row->name }}">{{ substr($row->name, 0, 10) }}...</a>
                                                        </div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                ...
                                <div class="owl-item">
                                    <div class="trends_item is_new">
                                        ...
                                        <div class="trends_content">
                                            ...
                                            <div class="trends_info clearfix">
                                                <div class="trends_name"><a
                                                        href="{{ route('product.details', $row->name) }}">{{ substr($row->name, 0, 10) }}...</a>
                                                </div>
                                        ...
                                        <div class="trends_fav">
                                            <a href="{{ route('add.wishlist', $row->id) }}"><i
